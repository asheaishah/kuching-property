  ...
  <div class="bg-theme-50">
    <div class="max-w-8xl px-4 py-12 mx-auto">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div class="space-y-2">
          ...
          <img
            src="@/assets/img/liedak_logo.png"
            alt="Singhaiyi Group Pte. Ltd."
            class="object-contain h-40"
          />
        </div>
        <div class="space-y-2">
          <h4 class="text-xl font-medium">LD Legenda @ Kozi Square</h4>
          <ul class="space-y-3 text-gray-600">
            <li>Developer: LIENDAK</li>
          </ul>
        </div>
        <div class="space-y-2">
          ...
          <ul class="space-y-3 text-gray-600">
            <li>
              <NuxtLink to="/" exact class="nuxt-link-exact-active nuxt-link-active">LD Legenda @ Kozi Square</NuxtLink>
            </li>
            <li><NuxtLink to="/floor-plan">Floor Plan LD Legenda @ Kozi Square</NuxtLink></li>
            <li><NuxtLink to="/pricing">Pricing LD Legenda @ Kozi Square</NuxtLink></li>
        ...
        <div class="space-y-2">
          ...
          <ul class="space-y-3 text-gray-600">
            ...
            <li class="flex items-center space-x-2">
              ...
              <a href="tel:+6591992282">+65 9199 2282</a>
            </li>
            <li class="flex items-center space-x-2">
              <svg
                fill="none"
              ...
              <a href="mailto:sales@grand-dunman.com.sg">sales@kuchingproperty.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="max-w-6xl px-4 mx-auto space-y-2">
        <div class="text-sm text-gray-500">
          <div class="flex flex-wrap justify-center max-w-4xl mx-auto divide-x divide-gray-500">
            ...
            <p class="px-1">LD Legenda @ Kozi Square</p>
            <p class="px-1">LIENDAK</p>
            <p class="px-1"><a href="tel:+6591992282">+65 9199 2282</a></p>
    ...
    <div class="header-chat">
      <div class="head-home">
        ...
        <p>
          <span class="whatsapp-name">LD Legenda @ Kozi Square</span><br />
        ...
        <div class="WhatsappChat__MessageContainer-sc-1wqac52-1 dAbFpq">
          ...
          >
            ...
            <div class="WhatsappChat__Text-sc-1wqac52-2 iSpIQi">
              Thank you for expressing your interest in LD Legenda @ Kozi Square👋<br /><br />How may I assist you today?
            </div>
...
export default {
  ...
  methods: {
    sendMessage() {
      ...
      if (input.value !== '') {
        const phoneNumber = '+6591992282'; // Update with your phone number
